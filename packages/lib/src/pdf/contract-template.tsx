    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>패키지서비스 비용</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.article}>
            <Text style={styles.articleContent}>
              ...
              3. 모든 제작물 완료 후 해지 시: 환불 불가 (서비스 용역이 모두 제공된 것으로 간주){'\n'}
              4. 환불 시 제작된 홈페이지는 즉시 사용이 중단된다.{'\n'}
              5. 환불 시 광고지원 서비스는 모두 중단된다.{'\n'}
              6. 갑의 자료 미제공, 연락 두절 등 갑의 귀책사유로 인한 진행 불가 시: 환불 불가{'\n'}
              7. 환불 신청은 서면(이메일 포함)으로만 접수되며, 환불은 신청일로부터 7영업일 이내에 처리된다.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.article}>
            <Text style={styles.articleContent}>
              ...
              {isPromotion ? '' : '5. Meta 광고 연동 서비스 무료 기간 종료 후 계속 이용 시 아래 요금이 청구된다. (부가세 별도)\n   - 3개월 단위 결제: 660,000원 (월 220,000원)\n   - 6개월 단위 결제: 990,000원 (월 165,000원)\n   - 12개월 단위 결제: 1,320,000원 (월 110,000원)\n'}
